...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="http://www.bitbytemedia.com" title="Bit Byte Media"><img src="http://www.kulinarykidz.com/newAdmin/images/logo-transparent.png" width="145" height="142" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<div id="login-inner">
		...
		<tr>
			<th></th>
			<td><input type="button" class="submit-login" value="login"  /></td>
		</tr>
		</table>
	</div>
 	<!--  end login-inner -->
