...
<head>
  ...
  <title>Bit Byte Media | 404 </title>
	...
	<section id="content-wrapper">
		<section id="content" class="clearfix">
			<div class="main-content">
						<h1><img src="/images/error.png" alt="Error" height="40" width="40" class="title-icon" />Uh-Oh <span frown>:(</span></h1>
                        ...
                        <div>
                         ...
                         <p>Rest assured, we are working on this.  By the time you read this, an email has already been sent to us and we are probably already working on the fix.</p>
                         <p>In the meantime,  use the navigation above to find the page you were looking for.</p>
			</div>
